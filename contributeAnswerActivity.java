        ...
        FirebaseAuth.getInstance().signInWithEmailAndPassword(emailET.getText().toString(),passET.getText().toString())
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        Toast.makeText(contributeAnswerActivity.this, "Verify success", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(contributeAnswerActivity.this, "Verify Failed!"+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
